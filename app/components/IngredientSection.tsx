        ...
        <div className="bg-gray-50 py-[50px] px-[30px]">
            ...
            <div className="flex items-center">
                ...
                <div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden shadow">
                    ...
                    <img src="/images/protein.png" alt="Whey Protein" className="max-h-[300px]" />
                    </div>
                    ...
                    <div className="bg-zinc-900 text-white text-center p-6">
                        ...
                        {features.map((text, i) => (
                            ...
                            <div className="bg-zinc-800 w-10 h-10 flex items-center justify-center rounded-full text-xl">{icons[i]}</div>
                    ...
                    <div className="bg-white p-6 grid md:grid-cols-3 gap-4 text-center">
                        <h4 className="col-span-full text-lg font-semibold mb-2">Active Ingredients</h4>
                        {ingredients.map((item, i) => (
                        <div key={i} className="flex flex-col gap-2">
                            <div className="w-10 h-10 bg-gray-100 rounded-full text-xl flex items-center justify-center">🌿</div>
