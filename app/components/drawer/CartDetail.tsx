      ...
      >
        <div className="p-5 flex justify-between border-b border-b-[#d3d3d3]">
          <div className='flex items-center'>
            ...
            <div className='text-[18px] bg-black text-white w-[36px] h-[36px] flex items-center justify-center rounded-full ml-[10px]'>2</div>
          </div>
          <button onClick={() => props.setOpen(false)} className="text-[30px]">&times;</button>
        </div>
        <div className='px-5 pt-5'>
            <div className='text-center text-[16px]'>You are <strong>$45.44 away</strong> from eligible for free shipping</div>
            ...
            <div className='flex items-center justify-between mt-5'>
                ...
                <div className='flex'>
                     <div className="w-[50px] h-[50px] border border-gray-300 rounded-[10px] flex justify-center items-center bg-[#F5F5F5]"><img src="/images/arrow.png" className="-rotate-135"/></div>
                     <div className="w-[50px] h-[50px] border border-gray-300 rounded-[10px] flex justify-center items-center bg-[#F5F5F5] ml-2"><img src="/images/arrow.png" className="rotate-45"/></div>
                </div>
            </div>
            <div className='mb-5'>
                <div className='p-[20px] text-[14px] w-[220px] bg-[#F5F5F5] flex flex-col items-center rounded-[10px]'>
                    <img className='w-[140px] h-[140px]' src = "/images/bundle.png"/>
                    <div className='font-bold'>Tongkat & Fadogia 60 Day Supply</div>
                    <div className='flex justify-between items-center w-full'>
                        <span>$49.95</span>
                        <div className='text-white bg-black rounded-[5px] px-3 py-1'>Add to Cart  +</div>
                    </div>
                </div>
            </div>
        </div>
        <div className='border-t-[px] border-t-[#F5F5F5] px-5'>
            <div className='flex justify-between items-center'>
                ...
                <span className='text-[#1B1F2399] text-[14px]'>Tax included. Shipping calculated at checkout.</span>
                </div>
